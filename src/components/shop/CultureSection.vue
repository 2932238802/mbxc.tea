    ...
    <div class="row g-4">
      <div class="col-lg-7">
        <div class="card border-0 shadow-sm p-4 h-100">
          ...
          <div class="row g-3">
            <div class="col-md-4"><div class="p-3 border rounded bg-light h-100"><div class="fw-bold mb-1">采茶体验</div><small class="text-muted">深入核心茶园，亲手采摘</small></div></div>
            <div class="col-md-4"><div class="p-3 border rounded bg-light h-100"><div class="fw-bold mb-1">非遗炒茶</div><small class="text-muted">看技艺、学手法、带走成品</small></div></div>
            <div class="col-md-4"><div class="p-3 border rounded bg-light h-100"><div class="fw-bold mb-1">茶主题研学</div><small class="text-muted">亲子与团体研学课程</small></div></div>
          </div>
        </div>
      </div>
      <div class="col-lg-5">
          ...
          <form @submit.prevent="submitBooking" class="row g-3">
            <div class="col-12">
              ...
              <select class="form-select" v-model="project" required>
                ...
                <option>采茶</option><option>炒茶</option><option>研学</option>
              </select>
            </div>
            <div class="col-12">
            ...
            <div class="col-12 d-grid">
              <button type="submit" class="btn btn-success rounded-pill"><i class="fas fa-paper-plane me-2"></i>提交预约</button>
            </div>
            <div class="col-12 d-grid" v-if="booked">
              <button type="button" class="btn btn-outline-danger rounded-pill" @click="cancelBooking"><i class="fas fa-xmark me-2"></i>取消预约</button>
            </div>
...
.section-title {
  font-size: 1.8rem; font-weight: 700; color: var(--tea-primary);
