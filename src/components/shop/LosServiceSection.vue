...
const baseCards: Record<TabKey, ServiceCard[]> = {
  brand: [
    ...
    },
    {
      ...
      image: '手工·匠心.jpg',
      tone: 'dark-green',
      desc: '茶品名称是茶企品牌核心要素，是建立茶企品牌认知的第一印象。',
      points: ['产品命名', '品牌口号', '传播记忆点'],
    },
    {
      title: '品牌形象设计',
      tag: '视觉',
    ...
    },
    {
      ...
      image: '以茶代酒.jpg',
      tone: 'teal',
      desc: '根据茶企茶叶产品特点与上市季节，筹备线下企业品牌发布会、推介会等活动。',
      points: ['发布会策划', '茶文旅联名', '线下推介会'],
    },
    {
      title: '企业品牌宣传片拍摄',
      tag: '影像',
      image: '数字.jpg',
      tone: 'blue',
      desc: '根据前期品牌定位、品牌名称、品牌口号，拟定茶企品牌宣传片脚本并完成拍摄制作。',
      points: ['脚本策划', '短视频拍摄', '传播素材沉淀'],
    },
  ],
  quality: [
